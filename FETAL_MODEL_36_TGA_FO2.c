...
/*
   ...
   There are a total of 189 entries in the constant variable array.
 */
/*
 ...
 * CONSTANTS[173] is tact in component LA (second).
 * CONSTANTS[180] is td in component LA (second).
 * CONSTANTS[179] is trise in component LA (second).
 ...
 * ALGEBRAIC[141] is Pi in component LV (UnitP).
 * ALGEBRAIC[146] is Qo in component Bif_LUNG1in_FO2in_LAout (UnitQ).
 ...
 * ALGEBRAIC[86] is Linductance in component LA (UnitL).
 ...
 * ALGEBRAIC[83] is Aeff in component LA (UnitA).
 * CONSTANTS[23] is Ami in component Parameters (UnitA).
 * ALGEBRAIC[88] is B in component LA (UnitB).
 * ALGEBRAIC[152] is val_xi in component LA (ode_s).
 * CONSTANTS[24] is B_param in component Parameters (UnitBparam).
 * ALGEBRAIC[87] is L in component RA (dimensionless).
 * ALGEBRAIC[113] is Ls in component RA (Unitl).
 * STATES[5] is Lsc in component RA (Unitl).
 * ALGEBRAIC[126] is Lsnorm in component RA (dimensionless).
 * ALGEBRAIC[89] is ta in component RA (second).
 * CONSTANTS[174] is tact in component RA (second).
 * CONSTANTS[182] is td in component RA (second).
 * CONSTANTS[181] is trise in component RA (second).
 ...
 * ALGEBRAIC[122] is sfpas in component RA (UnitP).
 * ALGEBRAIC[90] is sfact in component RA (UnitP).
 * ALGEBRAIC[93] is sfrest in component RA (UnitP).
 * ALGEBRAIC[128] is sf in component RA (UnitP).
 * CONSTANTS[27] is delay_ra in component Parameters (second).
 * ALGEBRAIC[82] is Time in component RA (second).
 * ALGEBRAIC[95] is Time2 in component RA (second).
 * ALGEBRAIC[85] is xrise in component RA (dimensionless).
 * ALGEBRAIC[92] is fRise in component RA (dimensionless).
 * ALGEBRAIC[98] is fDecay in component RA (dimensionless).
 * ALGEBRAIC[116] is xPos in component RA (dimensionless).
 * ALGEBRAIC[118] is xSarc in component RA (dimensionless).
 * ALGEBRAIC[120] is y in component RA (dimensionless).
 * ALGEBRAIC[124] is NoBuckle in component RA (dimensionless).
 * ALGEBRAIC[96] is Vm in component RA (UnitV).
 * ALGEBRAIC[99] is Cm in component RA (Unitc).
 * ALGEBRAIC[105] is Am in component RA (UnitA).
 * ALGEBRAIC[102] is Amtotal in component RA (UnitA).
 * CONSTANTS[28] is Amdead_ra in component Parameters (UnitA).
 * CONSTANTS[29] is Amref_ra in component Parameters (UnitA).
 * ALGEBRAIC[108] is z in component RA (dimensionless).
 * ALGEBRAIC[111] is Ef in component RA (dimensionless).
 * ALGEBRAIC[130] is Tension in component RA (UnitT).
 * ALGEBRAIC[132] is Pi in component RA (UnitP).
 * ALGEBRAIC[178] is Pi in component RV (UnitP).
 * ALGEBRAIC[185] is Qo in component Bif_SVC1in_IVC2in_DV3in_Coronary4in_RAout (UnitQ).
 ...
 * ALGEBRAIC[138] is Linductance in component RA (UnitL).
 * CONSTANTS[33] is L_min_tr in component Parameters (UnitL).
 * STATES[9] is xi in component RA (dimensionless).
 * ALGEBRAIC[134] is Aeff in component RA (UnitA).
 * CONSTANTS[34] is Atr in component Parameters (UnitA).
 * ALGEBRAIC[142] is B in component RA (UnitB).
 * ALGEBRAIC[188] is val_xi in component RA (ode_s).
 * ALGEBRAIC[155] is L in component RV (dimensionless).
 * ALGEBRAIC[169] is Ls in component RV (Unitl).
 * STATES[10] is Lsc in component RV (Unitl).
 * ALGEBRAIC[175] is Lsnorm in component RV (dimensionless).
 * ALGEBRAIC[157] is ta in component RV (second).
 * CONSTANTS[175] is tact in component RV (second).
 * CONSTANTS[184] is td in component RV (second).
 * CONSTANTS[183] is trise in component RV (second).
 ...
 * ALGEBRAIC[173] is sfpas in component RV (UnitP).
 * ALGEBRAIC[158] is sfact in component RV (UnitP).
 * ALGEBRAIC[160] is sfrest in component RV (UnitP).
 * ALGEBRAIC[176] is sf in component RV (UnitP).
 ...
 * ALGEBRAIC[147] is Time in component RV (second).
 * ALGEBRAIC[161] is Time2 in component RV (second).
 * ALGEBRAIC[153] is xrise in component RV (dimensionless).
 * ALGEBRAIC[159] is fRise in component RV (dimensionless).
 * ALGEBRAIC[163] is fDecay in component RV (dimensionless).
 * ALGEBRAIC[170] is xPos in component RV (dimensionless).
 * ALGEBRAIC[171] is xSarc in component RV (dimensionless).
 * ALGEBRAIC[172] is y in component RV (dimensionless).
 * ALGEBRAIC[174] is NoBuckle in component RV (dimensionless).
 * ALGEBRAIC[162] is Vm in component RV (UnitV).
 * ALGEBRAIC[164] is Cm in component RV (Unitc).
 * ALGEBRAIC[166] is Am in component RV (UnitA).
 * ALGEBRAIC[165] is Amtotal in component RV (UnitA).
 * CONSTANTS[44] is Amdead_rv in component Parameters (UnitA).
 * CONSTANTS[45] is Amref_rv in component Parameters (UnitA).
 * ALGEBRAIC[167] is z in component RV (dimensionless).
 * ALGEBRAIC[168] is Ef in component RV (dimensionless).
 * CONSTANTS[46] is kS_v in component Parameters (dimensionless).
 * ALGEBRAIC[177] is Tension in component RV (UnitT).
 * ALGEBRAIC[192] is Pi in component Bif_RVin_AA1out_Coronary2out (UnitP).
 * STATES[13] is Qo in component RV (UnitQ).
 ...
 * ALGEBRAIC[182] is Linductance in component RV (UnitL).
 * CONSTANTS[50] is L_min_pv in component Parameters (UnitL).
 * STATES[14] is xi in component RV (dimensionless).
 * ALGEBRAIC[180] is Aeff in component RV (UnitA).
 * CONSTANTS[51] is Apv in component Parameters (UnitA).
 * ALGEBRAIC[184] is B in component RV (UnitB).
 * ALGEBRAIC[193] is val_xi in component RV (ode_s).
 * ALGEBRAIC[97] is L in component LV (dimensionless).
 * ALGEBRAIC[119] is Ls in component LV (Unitl).
 * STATES[15] is Lsc in component LV (Unitl).
 * ALGEBRAIC[131] is Lsnorm in component LV (dimensionless).
 * ALGEBRAIC[100] is ta in component LV (second).
 * CONSTANTS[176] is tact in component LV (second).
 * CONSTANTS[186] is td in component LV (second).
 * CONSTANTS[185] is trise in component LV (second).
 * STATES[16] is C in component LV (dimensionless).
 * STATES[17] is Vcav in component LV (UnitV).
 * CONSTANTS[52] is Vlv0 in component Parameters (UnitV).
 * CONSTANTS[53] is Vwall_lv in component Parameters (UnitV).
 * ALGEBRAIC[127] is sfpas in component LV (UnitP).
 * ALGEBRAIC[101] is sfact in component LV (UnitP).
 * ALGEBRAIC[104] is sfrest in component LV (UnitP).
 * ALGEBRAIC[133] is sf in component LV (UnitP).
 * CONSTANTS[54] is delay_lv in component Parameters (second).
 * ALGEBRAIC[91] is Time in component LV (second).
 * ALGEBRAIC[106] is Time2 in component LV (second).
 * ALGEBRAIC[94] is xrise in component LV (dimensionless).
 * ALGEBRAIC[103] is fRise in component LV (dimensionless).
 * ALGEBRAIC[109] is fDecay in component LV (dimensionless).
 * ALGEBRAIC[121] is xPos in component LV (dimensionless).
 * ALGEBRAIC[123] is xSarc in component LV (dimensionless).
 * ALGEBRAIC[125] is y in component LV (dimensionless).
 * ALGEBRAIC[129] is NoBuckle in component LV (dimensionless).
 * ALGEBRAIC[107] is Vm in component LV (UnitV).
 * ALGEBRAIC[110] is Cm in component LV (Unitc).
 * ALGEBRAIC[114] is Am in component LV (UnitA).
 * ALGEBRAIC[112] is Amtotal in component LV (UnitA).
 * CONSTANTS[55] is Amdead_lv in component Parameters (UnitA).
 * CONSTANTS[56] is Amref_lv in component Parameters (UnitA).
 * ALGEBRAIC[115] is z in component LV (dimensionless).
 * ALGEBRAIC[117] is Ef in component LV (dimensionless).
 * ALGEBRAIC[137] is Tension in component LV (UnitT).
 * STATES[18] is Pi in component PA_RCL (UnitP).
 ...
 * ALGEBRAIC[154] is Linductance in component LV (UnitL).
 * CONSTANTS[60] is L_min_ao in component Parameters (UnitL).
 * STATES[20] is xi in component LV (dimensionless).
 * ALGEBRAIC[148] is Aeff in component LV (UnitA).
 * CONSTANTS[61] is Aao in component Parameters (UnitA).
 * ALGEBRAIC[156] is B in component LV (UnitB).
 * ALGEBRAIC[149] is val_xi in component LV (ode_s).
 ...
 * ALGEBRAIC[190] is Qo1 in component Bif_RVin_AA1out_Coronary2out (UnitQ).
 ...
 * ALGEBRAIC[84] is Pi1 in component Bif_LUNG1in_FO2in_LAout (UnitP).
 ...
 * ALGEBRAIC[135] is Pi1 in component Bif_SVC1in_IVC2in_DV3in_Coronary4in_RAout (UnitP).
 ...
 * ALGEBRAIC[194] is Pi in component Bif_UVin_DV1out_HE2out (UnitP).
 ...
 * ALGEBRAIC[143] is Pi in component Bif_IVCin_FO1out_RA2out (UnitP).
 ...
 * ALGEBRAIC[196] is Pi in component Coronary_R (UnitP).
 * ALGEBRAIC[195] is Pi4 in component Bif_SVC1in_IVC2in_DV3in_Coronary4in_RAout (UnitP).
 * STATES[102] is Qo2 in component Bif_RVin_AA1out_Coronary2out (UnitQ).
 * ALGEBRAIC[179] is Qo in component Coronary_R (UnitQ).
 * ALGEBRAIC[187] is R in component Coronary_R (UnitR).
 ...
 * ALGEBRAIC[191] is Pi in component Bif_DVin_FO1out_RA2out (UnitP).
 * ALGEBRAIC[186] is Pi1 in component Bif_UV1in_INTE2in_AO3in_HEout (UnitP).
 * ALGEBRAIC[181] is Qo1 in component Bif_UVin_DV1out_HE2out (UnitQ).
 * STATES[104] is Qo2 in component Bif_UVin_DV1out_HE2out (UnitQ).
 * CONSTANTS[152] is Rha in component Parameters (UnitR).
 * ALGEBRAIC[139] is Pi2 in component Bif_DV1in_IVC2in_FOout (UnitP).
 * ALGEBRAIC[150] is Pi2 in component Bif_SVC1in_IVC2in_DV3in_Coronary4in_RAout (UnitP).
 * ALGEBRAIC[136] is Qo1 in component Bif_IVCin_FO1out_RA2out (UnitQ).
 ...
 * ALGEBRAIC[189] is Pi3 in component Bif_SVC1in_IVC2in_DV3in_Coronary4in_RAout (UnitP).
 * STATES[107] is Qo1 in component Bif_DVin_FO1out_RA2out (UnitQ).
 * ALGEBRAIC[183] is Qo2 in component Bif_DVin_FO1out_RA2out (UnitQ).
 * ALGEBRAIC[17] is v1 in component Bif_DVin_FO1out_RA2out (UnitVel).
 * CONSTANTS[155] is Rdv in component Parameters (UnitR).
 * CONSTANTS[156] is Kdv in component Parameters (UnitK).
 * CONSTANTS[177] is R1 in component Bif_DVin_FO1out_RA2out (UnitR).
 * CONSTANTS[178] is K1 in component Bif_DVin_FO1out_RA2out (UnitK).
 * CONSTANTS[157] is Adv in component Parameters (UnitA).
 * CONSTANTS[187] is R2 in component Bif_DVin_FO1out_RA2out (UnitR).
 * CONSTANTS[188] is K2 in component Bif_DVin_FO1out_RA2out (UnitK).
 * CONSTANTS[158] is percentage_DV_to_FO in component Parameters (dimensionless).
 * CONSTANTS[159] is Ldv in component Parameters (UnitL).
 ...
 * CONSTANTS[160] is Rmea in component Parameters (UnitR).
 * CONSTANTS[161] is Relg in component Parameters (UnitR).
 * CONSTANTS[162] is Rrea in component Parameters (UnitR).
 ...
 * ALGEBRAIC[140] is Pi2 in component Bif_LUNG1in_FO2in_LAout (UnitP).
 * STATES[109] is Qo in component Bif_DV1in_IVC2in_FOout (UnitQ).
 * STATES[110] is V in component Bif_DV1in_IVC2in_FOout (UnitV).
 * CONSTANTS[163] is Kfo in component Parameters (UnitKfo).
 * CONSTANTS[164] is Kfovo in component Parameters (UnitKxi).
 * CONSTANTS[165] is Kfovc_p in component Parameters (UnitKxi).
 * CONSTANTS[166] is Kfovc_n in component Parameters (UnitKxi).
 * ALGEBRAIC[151] is Linductance in component Bif_DV1in_IVC2in_FOout (UnitL).
 * CONSTANTS[167] is L_min_fo in component Parameters (UnitL).
 * STATES[111] is xi in component Bif_DV1in_IVC2in_FOout (dimensionless).
 * ALGEBRAIC[144] is val_xi in component Bif_DV1in_IVC2in_FOout (ode_s).
 * ALGEBRAIC[145] is Aeff in component Bif_DV1in_IVC2in_FOout (UnitA).
 * CONSTANTS[168] is Afo in component Parameters (UnitA).
 * CONSTANTS[169] is Rdv_fo in component Parameters (UnitR).
 * CONSTANTS[170] is Rdv_ra in component Parameters (UnitR).
 * CONSTANTS[171] is Kdv_fo in component Parameters (UnitK).
 * CONSTANTS[172] is Kdv_ra in component Parameters (UnitK).
 ...
 * RATES[13] is d/dt Qo in component RV (UnitQ).
 * RATES[14] is d/dt xi in component RV (dimensionless).
 * RATES[16] is d/dt C in component LV (dimensionless).
 * RATES[15] is d/dt Lsc in component LV (Unitl).
 * RATES[17] is d/dt Vcav in component LV (UnitV).
 ...
 * RATES[18] is d/dt Pi in component PA_RCL (UnitP).
 ...
 * RATES[102] is d/dt Qo2 in component Bif_RVin_AA1out_Coronary2out (UnitQ).
...
CONSTANTS[158] = 0.9;
CONSTANTS[159] = 0.00005;
STATES[108] = 0.;
CONSTANTS[160] = 38.572;
CONSTANTS[161] = 91.8888;
CONSTANTS[162] = 19.853;
STATES[109] = 0.;
STATES[110] = 0;
CONSTANTS[163] = 0.21;
CONSTANTS[164] = 180;
CONSTANTS[165] = 1000;
CONSTANTS[166] = 1000;
CONSTANTS[167] = 0.0011665;
STATES[111] = 1.0;
CONSTANTS[168] = 0.471;
CONSTANTS[169] = 1.5522;
CONSTANTS[170] = 29.492;
CONSTANTS[171] = 0.306;
CONSTANTS[172] = 5.81;
CONSTANTS[173] = CONSTANTS[2];
CONSTANTS[174] = CONSTANTS[2];
CONSTANTS[175] = CONSTANTS[35];
CONSTANTS[176] = CONSTANTS[35];
CONSTANTS[177] = CONSTANTS[155]/CONSTANTS[158];
CONSTANTS[178] = CONSTANTS[156]/CONSTANTS[158];
CONSTANTS[179] =  CONSTANTS[3]*CONSTANTS[173];
CONSTANTS[180] =  CONSTANTS[4]*CONSTANTS[173];
CONSTANTS[181] =  CONSTANTS[3]*CONSTANTS[174];
CONSTANTS[182] =  CONSTANTS[4]*CONSTANTS[174];
CONSTANTS[183] =  CONSTANTS[36]*CONSTANTS[175];
CONSTANTS[184] =  CONSTANTS[37]*CONSTANTS[175];
CONSTANTS[185] =  CONSTANTS[36]*CONSTANTS[176];
CONSTANTS[186] =  CONSTANTS[37]*CONSTANTS[176];
CONSTANTS[187] = CONSTANTS[155]/(1.00000 - CONSTANTS[158]);
CONSTANTS[188] = CONSTANTS[156]/(1.00000 - CONSTANTS[158]);
}
void
...
CONSTANTS[187] = CONSTANTS[155]/(1.00000 - CONSTANTS[158]);
CONSTANTS[188] = CONSTANTS[156]/(1.00000 - CONSTANTS[158]);
RATES[12] = STATES[8] - STATES[13];
RATES[17] = STATES[3] - STATES[19];
RATES[18] = (STATES[19] - STATES[30])/CONSTANTS[73];
RATES[31] = STATES[19] - STATES[30];
...
RATES[75] = ((ALGEBRAIC[14] - STATES[74]) -  CONSTANTS[160]*STATES[75])/CONSTANTS[77];
RATES[72] = ((ALGEBRAIC[14] - STATES[71]) -  CONSTANTS[162]*STATES[72])/CONSTANTS[77];
...
RATES[108] = ((ALGEBRAIC[14] - ALGEBRAIC[29]) -  CONSTANTS[161]*STATES[108])/CONSTANTS[77];
ALGEBRAIC[31] = STATES[67]+ CONSTANTS[143]*ALGEBRAIC[25];
RATES[30] = ((STATES[18] - ALGEBRAIC[31]) -  CONSTANTS[72]*STATES[30])/CONSTANTS[74];
...
ALGEBRAIC[0] = ((VOI - CONSTANTS[11]) -  CONSTANTS[17]*floor((VOI - CONSTANTS[11])/CONSTANTS[17]))/CONSTANTS[179];
ALGEBRAIC[18] = fmin( 8.00000, fmax( ALGEBRAIC[0], 0.00000));
ALGEBRAIC[42] = (  tanh( 4.00000*pow(ALGEBRAIC[30], 2.00000))*pow(ALGEBRAIC[18], 3.00000)*exp(- ALGEBRAIC[18])*pow(8.00000 - ALGEBRAIC[18], 2.00000)*0.0200000)/CONSTANTS[179];
ALGEBRAIC[37] =  CONSTANTS[173]*(0.650000+ 0.700000*ALGEBRAIC[30]);
ALGEBRAIC[46] = (((VOI - CONSTANTS[11]) -  CONSTANTS[17]*floor((VOI - CONSTANTS[11])/CONSTANTS[17])) - ALGEBRAIC[37])/CONSTANTS[180];
ALGEBRAIC[50] = (0.500000+ 0.500000* sin( (ALGEBRAIC[46]/fabs(ALGEBRAIC[46]))*fmin(  3.14159265358979/2.00000, fabs(ALGEBRAIC[46]))))/CONSTANTS[180];
...
ALGEBRAIC[84] = ALGEBRAIC[81];
RATES[33] = ((STATES[32] - ALGEBRAIC[84]) -  CONSTANTS[75]*STATES[33])/CONSTANTS[77];
ALGEBRAIC[87] = fmax( (STATES[5] - 1.51000)/1.00000, 0.000100000);
ALGEBRAIC[82] = ((VOI - CONSTANTS[27]) -  CONSTANTS[17]*floor((VOI - CONSTANTS[27])/CONSTANTS[17]))/CONSTANTS[181];
ALGEBRAIC[85] = fmin( 8.00000, fmax( ALGEBRAIC[82], 0.00000));
ALGEBRAIC[92] = (  tanh( 4.00000*pow(ALGEBRAIC[87], 2.00000))*pow(ALGEBRAIC[85], 3.00000)*exp(- ALGEBRAIC[85])*pow(8.00000 - ALGEBRAIC[85], 2.00000)*0.0200000)/CONSTANTS[181];
ALGEBRAIC[89] =  CONSTANTS[174]*(0.650000+ 0.700000*ALGEBRAIC[87]);
ALGEBRAIC[95] = (((VOI - CONSTANTS[27]) -  CONSTANTS[17]*floor((VOI - CONSTANTS[27])/CONSTANTS[17])) - ALGEBRAIC[89])/CONSTANTS[182];
ALGEBRAIC[98] = (0.500000+ 0.500000* sin( (ALGEBRAIC[95]/fabs(ALGEBRAIC[95]))*fmin(  3.14159265358979/2.00000, fabs(ALGEBRAIC[95]))))/CONSTANTS[182];
RATES[6] = ALGEBRAIC[92] -  STATES[6]*ALGEBRAIC[98];
ALGEBRAIC[97] = fmax( (STATES[15] - 1.51000)/1.00000, 0.000100000);
ALGEBRAIC[91] = ((VOI - CONSTANTS[54]) -  CONSTANTS[17]*floor((VOI - CONSTANTS[54])/CONSTANTS[17]))/CONSTANTS[185];
ALGEBRAIC[94] = fmin( 8.00000, fmax( ALGEBRAIC[91], 0.00000));
ALGEBRAIC[103] = (  tanh( 4.00000*pow(ALGEBRAIC[97], 2.00000))*pow(ALGEBRAIC[94], 3.00000)*exp(- ALGEBRAIC[94])*pow(8.00000 - ALGEBRAIC[94], 2.00000)*0.0200000)/CONSTANTS[185];
ALGEBRAIC[100] =  CONSTANTS[176]*(0.650000+ 0.700000*ALGEBRAIC[97]);
ALGEBRAIC[106] = (((VOI - CONSTANTS[54]) -  CONSTANTS[17]*floor((VOI - CONSTANTS[54])/CONSTANTS[17])) - ALGEBRAIC[100])/CONSTANTS[186];
ALGEBRAIC[109] = (0.500000+ 0.500000* sin( (ALGEBRAIC[106]/fabs(ALGEBRAIC[106]))*fmin(  3.14159265358979/2.00000, fabs(ALGEBRAIC[106]))))/CONSTANTS[186];
RATES[16] = ALGEBRAIC[103] -  STATES[16]*ALGEBRAIC[109];
ALGEBRAIC[96] = STATES[7]+ 0.500000*CONSTANTS[26];
ALGEBRAIC[99] = pow(( 4.00000* 3.14159265358979)/( 3.00000*ALGEBRAIC[96]), 1.00000/3.00000);
ALGEBRAIC[102] = ( 4.00000* 3.14159265358979)/pow(ALGEBRAIC[99], 2.00000);
ALGEBRAIC[105] = ALGEBRAIC[102] - CONSTANTS[28];
ALGEBRAIC[108] = ( 1.50000*CONSTANTS[26]*ALGEBRAIC[99])/ALGEBRAIC[105];
ALGEBRAIC[111] = ( 0.500000*log(ALGEBRAIC[105]/CONSTANTS[29]) - pow(ALGEBRAIC[108], 2.00000)/12.0000) -  0.0190000*pow(ALGEBRAIC[108], 4.00000);
ALGEBRAIC[113] =  exp(ALGEBRAIC[111])*CONSTANTS[0];
ALGEBRAIC[126] = fmax( (ALGEBRAIC[113] - STATES[5])/0.0400000, - 0.0200000);
ALGEBRAIC[116] = fmax(  CONSTANTS[15]*log(ALGEBRAIC[113]/1.80000), 0.00000);
ALGEBRAIC[118] = log(ALGEBRAIC[113]/CONSTANTS[0])+0.100000;
ALGEBRAIC[120] =  0.120000*(cosh( 5.00000*ALGEBRAIC[116]) - 1.00000)+ALGEBRAIC[118];
ALGEBRAIC[122] =  CONSTANTS[8]*ALGEBRAIC[120];
ALGEBRAIC[124] =  tanh( 10.0000*STATES[6]+fmax( 0.00000,  0.000100000*pow(ALGEBRAIC[122], 2.00000)));
RATES[5] = ( fmax( ALGEBRAIC[126] - 1.00000,  ALGEBRAIC[124]*(ALGEBRAIC[126] - 1.00000))*CONSTANTS[10]*0.850000)/CONSTANTS[17];
ALGEBRAIC[107] = STATES[17]+ 0.500000*CONSTANTS[53];
ALGEBRAIC[110] = pow(( 4.00000* 3.14159265358979)/( 3.00000*ALGEBRAIC[107]), 1.00000/3.00000);
ALGEBRAIC[112] = ( 4.00000* 3.14159265358979)/pow(ALGEBRAIC[110], 2.00000);
ALGEBRAIC[114] = ALGEBRAIC[112] - CONSTANTS[55];
ALGEBRAIC[115] = ( 1.50000*CONSTANTS[53]*ALGEBRAIC[110])/ALGEBRAIC[114];
ALGEBRAIC[117] = ( 0.500000*log(ALGEBRAIC[114]/CONSTANTS[56]) - pow(ALGEBRAIC[115], 2.00000)/12.0000) -  0.0190000*pow(ALGEBRAIC[115], 4.00000);
ALGEBRAIC[119] =  exp(ALGEBRAIC[117])*CONSTANTS[0];
ALGEBRAIC[131] = fmax( (ALGEBRAIC[119] - STATES[15])/0.0400000, - 0.0200000);
ALGEBRAIC[121] = fmax(  CONSTANTS[46]*log(ALGEBRAIC[119]/1.80000), 0.00000);
ALGEBRAIC[123] = log(ALGEBRAIC[119]/CONSTANTS[0])+0.100000;
ALGEBRAIC[125] =  0.120000*(cosh( 5.00000*ALGEBRAIC[121]) - 1.00000)+ALGEBRAIC[123];
ALGEBRAIC[127] =  CONSTANTS[40]*ALGEBRAIC[125];
ALGEBRAIC[129] =  tanh( 10.0000*STATES[16]+fmax( 0.00000,  0.000100000*pow(ALGEBRAIC[127], 2.00000)));
RATES[15] = ( fmax( ALGEBRAIC[131] - 1.00000,  ALGEBRAIC[129]*(ALGEBRAIC[131] - 1.00000))*CONSTANTS[42]*0.850000)/CONSTANTS[17];
ALGEBRAIC[90] =  CONSTANTS[9]*STATES[6]*ALGEBRAIC[87];
ALGEBRAIC[93] =  CONSTANTS[9]*CONSTANTS[12]*ALGEBRAIC[87];
ALGEBRAIC[128] = (fmax(  0.200000*ALGEBRAIC[122], ALGEBRAIC[122])+ (ALGEBRAIC[90]+ALGEBRAIC[93])*ALGEBRAIC[126]) - ALGEBRAIC[93];
ALGEBRAIC[130] =  (( ALGEBRAIC[128]*0.500000*(1.00000+ 0.270000*pow(ALGEBRAIC[108], 2.00000)))/ALGEBRAIC[105])*CONSTANTS[26];
ALGEBRAIC[132] =  2.00000*ALGEBRAIC[130]*ALGEBRAIC[99];
ALGEBRAIC[135] = ALGEBRAIC[132];
RATES[36] = ((STATES[35] - ALGEBRAIC[135]) -  CONSTANTS[78]*STATES[36])/CONSTANTS[77];
ALGEBRAIC[136] = STATES[45] - STATES[105];
RATES[110] = (STATES[107]+ALGEBRAIC[136]) - STATES[109];
RATES[106] = ((STATES[107]+ALGEBRAIC[136]) - STATES[109])/CONSTANTS[107];
ALGEBRAIC[101] =  CONSTANTS[41]*STATES[16]*ALGEBRAIC[97];
ALGEBRAIC[104] =  CONSTANTS[41]*CONSTANTS[12]*ALGEBRAIC[97];
ALGEBRAIC[133] = (fmax(  0.200000*ALGEBRAIC[127], ALGEBRAIC[127])+ (ALGEBRAIC[101]+ALGEBRAIC[104])*ALGEBRAIC[131]) - ALGEBRAIC[104];
ALGEBRAIC[137] =  (( ALGEBRAIC[133]*0.500000*(1.00000+ 0.270000*pow(ALGEBRAIC[115], 2.00000)))/ALGEBRAIC[114])*CONSTANTS[53];
ALGEBRAIC[141] =  2.00000*ALGEBRAIC[137]*ALGEBRAIC[110];
ALGEBRAIC[83] =  CONSTANTS[23]*STATES[4]+0.000100000;
ALGEBRAIC[86] = CONSTANTS[22]/ALGEBRAIC[83]+CONSTANTS[21];
ALGEBRAIC[88] = CONSTANTS[24]/pow(ALGEBRAIC[83], 2.00000);
RATES[3] = ((ALGEBRAIC[81] - ALGEBRAIC[141]) -  ALGEBRAIC[88]*STATES[3]*fabs(STATES[3]))/ALGEBRAIC[86];
ALGEBRAIC[139] = STATES[106];
ALGEBRAIC[143] = ALGEBRAIC[139]+ CONSTANTS[153]*ALGEBRAIC[136];
RATES[45] = ((STATES[44] - ALGEBRAIC[143]) -  CONSTANTS[84]*STATES[45])/CONSTANTS[77];
ALGEBRAIC[140] = ALGEBRAIC[81];
ALGEBRAIC[144] = (STATES[107]+ALGEBRAIC[136]>=STATES[109] ?  STATES[111]*CONSTANTS[165]*(STATES[106] - ALGEBRAIC[140]) :  STATES[111]*CONSTANTS[166]*(STATES[106] - ALGEBRAIC[140]));
RATES[111] = (STATES[106]>=ALGEBRAIC[140] ?  (1.00000 - STATES[111])*CONSTANTS[164]*(STATES[106] - ALGEBRAIC[140]) : ALGEBRAIC[144]);
ALGEBRAIC[146] = STATES[33]+STATES[109];
RATES[2] = ALGEBRAIC[146] - STATES[3];
ALGEBRAIC[149] = (STATES[3]>=STATES[19] ?  STATES[20]*CONSTANTS[58]*(ALGEBRAIC[141] - STATES[18]) :  STATES[20]*CONSTANTS[59]*(ALGEBRAIC[141] - STATES[18]));
RATES[20] = (ALGEBRAIC[141]>=STATES[18] ?  (1.00000 - STATES[20])*CONSTANTS[57]*(ALGEBRAIC[141] - STATES[18]) : ALGEBRAIC[149]);
ALGEBRAIC[150] = ALGEBRAIC[132];
RATES[105] = ((ALGEBRAIC[143] - ALGEBRAIC[150]) -  CONSTANTS[154]*STATES[105])/CONSTANTS[77];
ALGEBRAIC[145] =  CONSTANTS[168]*STATES[111]+0.000100000;
ALGEBRAIC[151] = CONSTANTS[22]/ALGEBRAIC[145]+CONSTANTS[167];
RATES[109] = (STATES[109]>=0.00000 ? ((STATES[106] - ALGEBRAIC[140]) -  (CONSTANTS[163]/ALGEBRAIC[145])*pow(fabs(STATES[109]), 0.625000))/ALGEBRAIC[151] : ((STATES[106] - ALGEBRAIC[140])+ (CONSTANTS[163]/ALGEBRAIC[145])*pow(fabs(STATES[109]), 0.625000))/ALGEBRAIC[151]);
ALGEBRAIC[152] = (ALGEBRAIC[146]>=STATES[3] ?  STATES[4]*CONSTANTS[19]*(ALGEBRAIC[81] - ALGEBRAIC[141]) :  STATES[4]*CONSTANTS[20]*(ALGEBRAIC[81] - ALGEBRAIC[141]));
RATES[4] = (ALGEBRAIC[81]>=ALGEBRAIC[141] ?  (1.00000 - STATES[4])*CONSTANTS[18]*(ALGEBRAIC[81] - ALGEBRAIC[141]) : ALGEBRAIC[152]);
ALGEBRAIC[148] =  CONSTANTS[61]*STATES[20]+0.000100000;
ALGEBRAIC[154] = CONSTANTS[22]/ALGEBRAIC[148]+CONSTANTS[60];
ALGEBRAIC[156] = CONSTANTS[24]/pow(ALGEBRAIC[148], 2.00000);
RATES[19] = ((ALGEBRAIC[141] - STATES[18]) -  ALGEBRAIC[156]*STATES[19]*fabs(STATES[19]))/ALGEBRAIC[154];
ALGEBRAIC[155] = fmax( (STATES[10] - 1.51000)/1.00000, 0.000100000);
ALGEBRAIC[147] = ((VOI - CONSTANTS[43]) -  CONSTANTS[17]*floor((VOI - CONSTANTS[43])/CONSTANTS[17]))/CONSTANTS[183];
ALGEBRAIC[153] = fmin( 8.00000, fmax( ALGEBRAIC[147], 0.00000));
ALGEBRAIC[159] = (  tanh( 4.00000*pow(ALGEBRAIC[155], 2.00000))*pow(ALGEBRAIC[153], 3.00000)*exp(- ALGEBRAIC[153])*pow(8.00000 - ALGEBRAIC[153], 2.00000)*0.0200000)/CONSTANTS[183];
ALGEBRAIC[157] =  CONSTANTS[175]*(0.650000+ 0.700000*ALGEBRAIC[155]);
ALGEBRAIC[161] = (((VOI - CONSTANTS[43]) -  CONSTANTS[17]*floor((VOI - CONSTANTS[43])/CONSTANTS[17])) - ALGEBRAIC[157])/CONSTANTS[184];
ALGEBRAIC[163] = (0.500000+ 0.500000* sin( (ALGEBRAIC[161]/fabs(ALGEBRAIC[161]))*fmin(  3.14159265358979/2.00000, fabs(ALGEBRAIC[161]))))/CONSTANTS[184];
RATES[11] = ALGEBRAIC[159] -  STATES[11]*ALGEBRAIC[163];
ALGEBRAIC[162] = STATES[12]+ 0.500000*CONSTANTS[39];
ALGEBRAIC[164] = pow(( 4.00000* 3.14159265358979)/( 3.00000*ALGEBRAIC[162]), 1.00000/3.00000);
ALGEBRAIC[165] = ( 4.00000* 3.14159265358979)/pow(ALGEBRAIC[164], 2.00000);
ALGEBRAIC[166] = ALGEBRAIC[165] - CONSTANTS[44];
ALGEBRAIC[167] = ( 1.50000*CONSTANTS[39]*ALGEBRAIC[164])/ALGEBRAIC[166];
ALGEBRAIC[168] = ( 0.500000*log(ALGEBRAIC[166]/CONSTANTS[45]) - pow(ALGEBRAIC[167], 2.00000)/12.0000) -  0.0190000*pow(ALGEBRAIC[167], 4.00000);
ALGEBRAIC[169] =  exp(ALGEBRAIC[168])*CONSTANTS[0];
ALGEBRAIC[175] = fmax( (ALGEBRAIC[169] - STATES[10])/0.0400000, - 0.0200000);
ALGEBRAIC[170] = fmax(  CONSTANTS[46]*log(ALGEBRAIC[169]/1.80000), 0.00000);
ALGEBRAIC[171] = log(ALGEBRAIC[169]/CONSTANTS[0])+0.100000;
ALGEBRAIC[172] =  0.120000*(cosh( 5.00000*ALGEBRAIC[170]) - 1.00000)+ALGEBRAIC[171];
ALGEBRAIC[173] =  CONSTANTS[40]*ALGEBRAIC[172];
ALGEBRAIC[174] =  tanh( 10.0000*STATES[11]+fmax( 0.00000,  0.000100000*pow(ALGEBRAIC[173], 2.00000)));
RATES[10] = ( fmax( ALGEBRAIC[175] - 1.00000,  ALGEBRAIC[174]*(ALGEBRAIC[175] - 1.00000))*CONSTANTS[42]*0.850000)/CONSTANTS[17];
ALGEBRAIC[158] =  CONSTANTS[41]*STATES[11]*ALGEBRAIC[155];
ALGEBRAIC[160] =  CONSTANTS[41]*CONSTANTS[12]*ALGEBRAIC[155];
ALGEBRAIC[176] = (fmax(  0.200000*ALGEBRAIC[173], ALGEBRAIC[173])+ (ALGEBRAIC[158]+ALGEBRAIC[160])*ALGEBRAIC[175]) - ALGEBRAIC[160];
ALGEBRAIC[177] =  (( ALGEBRAIC[176]*0.500000*(1.00000+ 0.270000*pow(ALGEBRAIC[167], 2.00000)))/ALGEBRAIC[166])*CONSTANTS[39];
ALGEBRAIC[178] =  2.00000*ALGEBRAIC[177]*ALGEBRAIC[164];
ALGEBRAIC[134] =  CONSTANTS[34]*STATES[9]+0.000100000;
ALGEBRAIC[138] = CONSTANTS[22]/ALGEBRAIC[134]+CONSTANTS[33];
ALGEBRAIC[142] = CONSTANTS[24]/pow(ALGEBRAIC[134], 2.00000);
RATES[8] = ((ALGEBRAIC[132] - ALGEBRAIC[178]) -  ALGEBRAIC[142]*STATES[8]*fabs(STATES[8]))/ALGEBRAIC[138];
ALGEBRAIC[179] = STATES[102];
ALGEBRAIC[181] = STATES[42] - STATES[104];
ALGEBRAIC[183] = ALGEBRAIC[181] - STATES[107];
ALGEBRAIC[185] = STATES[36]+STATES[105]+ALGEBRAIC[183]+ALGEBRAIC[179];
RATES[7] = ALGEBRAIC[185] - STATES[8];
ALGEBRAIC[188] = (ALGEBRAIC[185]>=STATES[8] ?  STATES[9]*CONSTANTS[31]*(ALGEBRAIC[132] - ALGEBRAIC[178]) :  STATES[9]*CONSTANTS[32]*(ALGEBRAIC[132] - ALGEBRAIC[178]));
RATES[9] = (ALGEBRAIC[132]>=ALGEBRAIC[178] ?  (1.00000 - STATES[9])*CONSTANTS[30]*(ALGEBRAIC[132] - ALGEBRAIC[178]) : ALGEBRAIC[188]);
ALGEBRAIC[190] = STATES[13] - STATES[102];
RATES[21] = (ALGEBRAIC[190] - STATES[22])/CONSTANTS[63];
RATES[23] = ALGEBRAIC[190] - STATES[22];
ALGEBRAIC[192] = STATES[21]+ CONSTANTS[143]*ALGEBRAIC[190];
ALGEBRAIC[180] =  CONSTANTS[51]*STATES[14]+0.000100000;
ALGEBRAIC[182] = CONSTANTS[22]/ALGEBRAIC[180]+CONSTANTS[50];
ALGEBRAIC[184] = CONSTANTS[24]/pow(ALGEBRAIC[180], 2.00000);
RATES[13] = ((ALGEBRAIC[178] - ALGEBRAIC[192]) -  ALGEBRAIC[184]*STATES[13]*fabs(STATES[13]))/ALGEBRAIC[182];
ALGEBRAIC[189] = ALGEBRAIC[132];
ALGEBRAIC[191] = ALGEBRAIC[189]+ CONSTANTS[187]*ALGEBRAIC[183]+ CONSTANTS[188]*ALGEBRAIC[183]*fabs(ALGEBRAIC[183]);
RATES[107] = (((ALGEBRAIC[191] - STATES[106]) -  CONSTANTS[177]*STATES[107]) -  CONSTANTS[178]*STATES[107]*fabs(STATES[107]))/CONSTANTS[159];
ALGEBRAIC[193] = (STATES[8]>=STATES[13] ?  STATES[14]*CONSTANTS[48]*(ALGEBRAIC[178] - ALGEBRAIC[192]) :  STATES[14]*CONSTANTS[49]*(ALGEBRAIC[178] - ALGEBRAIC[192]));
RATES[14] = (ALGEBRAIC[178]>=ALGEBRAIC[192] ?  (1.00000 - STATES[14])*CONSTANTS[47]*(ALGEBRAIC[178] - ALGEBRAIC[192]) : ALGEBRAIC[193]);
ALGEBRAIC[194] = ALGEBRAIC[191];
RATES[42] = ((STATES[41] - ALGEBRAIC[194]) -  CONSTANTS[82]*STATES[42])/CONSTANTS[77];
ALGEBRAIC[186] = STATES[86];
RATES[104] = ((ALGEBRAIC[194] - ALGEBRAIC[186]) -  CONSTANTS[152]*STATES[104])/CONSTANTS[77];
ALGEBRAIC[195] = ALGEBRAIC[132];
ALGEBRAIC[187] = CONSTANTS[139]+ (CONSTANTS[140]/(1.00000+exp( - 1.00000*(ALGEBRAIC[178] - CONSTANTS[142]))))*pow(ALGEBRAIC[178] - CONSTANTS[142], CONSTANTS[141]);
ALGEBRAIC[196] = ALGEBRAIC[195]+ ALGEBRAIC[187]*STATES[102];
RATES[102] = ((ALGEBRAIC[192] - ALGEBRAIC[196]) -  CONSTANTS[143]*STATES[102])/CONSTANTS[147];
}
void
